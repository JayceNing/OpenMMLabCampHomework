...
model = dict(
    ...
    init_cfg=dict(type='Pretrained', checkpoint='https://download.openmmlab.com/mmclassification/v0/resnet/resnet18_8xb32_in1k_20210831-fbbb1da6.pth')  # 这里是后添加的：加载预训练模型
    )
...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root='../../data/cats_dogs_dataset/training_set',  # 这里是后添加的：修改数据集路径
